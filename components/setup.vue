...
<template>
    <div class="md:mt-24 bg-gradient-to-b from-dark-blue via-dark-violet to-dark-pink text-white w-full flex flex-col md:flex-row px-6 py-4 space-y-4 md:space-y-0">
        <div class="flex flex-col md:flex-row w-full lg:w-3/12 lg:text-lg justify-center text-center">
        ...
        <div class="pt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-start lg:text-lg w-full max-w-sm lg:w-3/12 text-sm place-content-start gap-2">
