<template>
  ...
  <div class="w-full bg-slate-800 flex justify-center py-4 items-center space-x-4">
    <span class="text-white">Made with brain from <a class="underline hover:text-blue-400 hover:font-semibold" target="_blank" href="https://github.com/localhousee">Localhousee</a></span>
